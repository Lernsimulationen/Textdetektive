...
import { PlayerProfile, Chapter, Badge } from '../types';
...
export const GameProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const importProfileJSON = (jsonString: string): boolean => {
    try {
      ...
      if (parsed && typeof parsed === 'object' && 'xp' in parsed) {
        setProfile(parsed);
        return true;
      }
    } catch (e) {
